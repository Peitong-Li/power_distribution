...
public class IntelligentSwitch {
    ...
    public IntelligentSwitch() {
    }

    public IntelligentSwitch(int id, float sign, String areaName, int courtsId, Float voltage_A, Float voltage_B, Float voltage_C, Float current_A, Float current_B, Float current_C, String switchState, Float contactTemperature) {
        this.id = id;
        this.sign = sign;
