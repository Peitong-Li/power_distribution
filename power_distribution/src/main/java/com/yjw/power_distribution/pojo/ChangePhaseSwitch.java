...
//8、换相开关
public class ChangePhaseSwitch {
    ...
    public ChangePhaseSwitch() {
    }

    public ChangePhaseSwitch(int id, float sign, String areaName, int courtsId, Float voltage_A, Float voltage_B, Float voltage_C, Float current_A, Float current_B, Float current_C, String switchState) {
        this.id = id;
        this.sign = sign;
