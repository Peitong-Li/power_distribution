...
public class AreaMeter {
    ...
    private String areaName;    //台区区域侧（中压侧/配变侧/低压侧...）
    ...
    private Float apparentPower_A;           //A相视在功率
    private Float apparentPower_B;           //B相视在功率
    private Float apparentPower_C;           //C相视在功率
    private Float apparentPower_Total;        //总视在功率

    private Float distributionLoadRate;      //配变负载率
    private Float voltagePassRate;           //电压合格率
    private Float humiture;                  //温湿度
    private Float gasConcentration;          //环境瓦斯浓度

    public AreaMeter() {
    }

    public AreaMeter(int id, float sign, String areaName, int courtsId, Float voltage_A, Float voltage_B, Float voltage_C, Float current_A, Float current_B, Float current_C, Float activePower_A, Float activePower_B, Float activePower_C, Float activePower_Total, Float reactivePower_A, Float reactivePower_B, Float reactivePower_C, Float reactivePower_Total, Float apparentPower_A, Float apparentPower_B, Float apparentPower_C, Float apparentPower_Total, Float distributionLoadRate, Float voltagePassRate, Float humiture, Float gasConcentration) {
        this.id = id;
        this.sign = sign;
        ...
        this.apparentPower_Total = apparentPower_Total;
        this.distributionLoadRate = distributionLoadRate;
        this.voltagePassRate = voltagePassRate;
    ...
    public Float getApparentPower_A() {
        return apparentPower_A;
    }

    public void setApparentPower_A(Float apparentPower_A) {
        this.apparentPower_A = apparentPower_A;
    }

    public Float getApparentPower_B() {
        return apparentPower_B;
    }

    public void setApparentPower_B(Float apparentPower_B) {
        this.apparentPower_B = apparentPower_B;
    }

    public Float getApparentPower_C() {
        return apparentPower_C;
    }

    public void setApparentPower_C(Float apparentPower_C) {
        this.apparentPower_C = apparentPower_C;
    }

    public Float getApparentPower_Total() {
        return apparentPower_Total;
    }

    public void setApparentPower_Total(Float apparentPower_Total) {
        this.apparentPower_Total = apparentPower_Total;
    }

    public Float getDistributionLoadRate() {
        return distributionLoadRate;
    }

    public void setDistributionLoadRate(Float distributionLoadRate) {
        this.distributionLoadRate = distributionLoadRate;
    }

    public Float getVoltagePassRate() {
        return voltagePassRate;
    }

    public void setVoltagePassRate(Float voltagePassRate) {
        this.voltagePassRate = voltagePassRate;
    }
    ...
    public void setHumiture(Float humiture) {
        this.humiture = humiture;
    }
    ...
    public String toString() {
        return "AreaMeter{" +
                ...
                ", apparentPower_A=" + apparentPower_A +
                ", apparentPower_B=" + apparentPower_B +
                ", apparentPower_C=" + apparentPower_C +
                ", apparentPower_Total=" + apparentPower_Total +
                ", distributionLoadRate=" + distributionLoadRate +
                ", voltagePassRate=" + voltagePassRate +
                ", humiture=" + humiture +
